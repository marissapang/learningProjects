...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			BasicDocument basicDoc;
			for (int i=0; i<trials; i++) {
				basicDoc = new BasicDocument(text);
				basicDoc.getFleschScore();
			}
			long t2 = System.nanoTime();
			double basicTime = ((double)t2 - (double)t1)/1000000000;
			
			long t3 = System.nanoTime();
			EfficientDocument efficientDoc;
			for (int i = 0; i < trials; i++) {
				efficientDoc = new EfficientDocument(text);
				efficientDoc.getFleschScore();
			}	
			long t4 = System.nanoTime();
			double efficientTime = ((double)t4 - (double)t3)/1000000000;
