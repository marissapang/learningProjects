...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// AbstractMapProvider provider = new AcetateProvider.All();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map1 = new UnfoldingMap(this, 0, 0, 100, 100, provider);
		// map1 = new UnfoldingMap(this, "map1", 0, 0, 100, 100);
		...
		map2 = new UnfoldingMap(this, 105, 0, 100, 100, provider);
	    // map2 = new UnfoldingMap(this, "map2", 105, 0, 100, 100);
		map2.zoomAndPanTo(zoomLevel, new Location(41.9f, -87.7f));

		MapUtils.createDefaultEventDispatcher(this, map2, map1);
	}
