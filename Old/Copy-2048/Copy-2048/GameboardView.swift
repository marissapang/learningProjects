...
class GameboardView : UIView {
    ...
    // Return whether a given position is valid. Used foor bounds checking.
    ...
    func insertTile(at pos: (Int, Int), value: Int){
        ...
        UIView.animate(withDuration: tileExpandTime, delay: tilePopDelay, options: UIView.AnimationOptions(),
            ...
            completion: { finished in
                ...
                UIView.animate(withDuration: self.tileContractTime, animations: { () -> Void in tile.layer.setAffineTransform(CGAffineTransform.identity)
                })
        })
    }
